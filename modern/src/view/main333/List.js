        ...
        items: [
            ...
            },
            {
                ...
                items:[{
                    ...
                    ,title: 'Posiciones'
                    ,emptyText: '<p style="color:red;font-size:15px;margin-top:140px;margin-left:10px;">No hay datos</p>'
                    ...
                    ,columns: [
                      { text: '', dataIndex: 'pos', width:40,sortable: false},
                       ...
                       { text: 'P.Jugados', dataIndex: 'pj',width:80,sortable: false  },
                       { text: 'P.Ganados', dataIndex: 'pg', width:80,sortable: false },
                       { text: 'P.empatados', dataIndex: 'pe', width: 80,sortable: false  },
                       { text: 'P.perdidos', dataIndex: 'pp', width: 80 ,sortable: false },
                       { text: 'Goles a favor', dataIndex: 'gf', width: 70 ,sortable: false},
                       { text: 'Diferencia de goles ', dataIndex: 'dif', width: 70,sortable: false }
                    ],
