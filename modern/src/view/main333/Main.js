...
Ext.define('Plani.view.main.Main', {
    ...
    defaults: {
        ...
        tab: {
            iconAlign: 'top'
            ,width:70
            ,style:'font-size:10px;background:#2d552d;color:#f0f0f0;'
       ...
       Ext.Viewport.add({
             ...
             // modal: true,
              ...
              , items: [{
                 xtype:'button'
                ,text:'LOGIN'
                ,style: 'background-color:#2d552d;height:80px;color:#FFF;font-size:25px'
                ,margin:'0 0'
                ...
                xtype: 'passwordfield'
                 ...
                 ,style: 'background-color:#2d552d'
                  ...
                  text: 'Ingresar22',
                  xtype: 'button',
                  style: 'background-color:#2d552d;height:50px;color:#FFF;font-size:20px',
